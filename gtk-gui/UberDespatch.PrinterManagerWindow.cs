...
namespace UberDespatch
{
	public partial class PrinterManagerWindow
	{
		...
		private global::Gtk.HBox PrinterProfileScaleLayout1;

		private global::Gtk.Label PrinterProfilePageSizeLabel;

		private global::Gtk.Entry PrinterProfilePageWidthEntry;

		private global::Gtk.Entry PrinterProfilePageHeightEntry;
		...
		protected virtual void Build()
		{
			...
			w16.Fill = false;
			// Container child PrinterProfileDetailsLayout.Gtk.Box+BoxChild
			this.PrinterProfileScaleLayout1 = new global::Gtk.HBox();
			this.PrinterProfileScaleLayout1.Name = "PrinterProfileScaleLayout1";
			this.PrinterProfileScaleLayout1.Spacing = 6;
			// Container child PrinterProfileScaleLayout1.Gtk.Box+BoxChild
			this.PrinterProfilePageSizeLabel = new global::Gtk.Label();
			this.PrinterProfilePageSizeLabel.WidthRequest = 200;
			this.PrinterProfilePageSizeLabel.Name = "PrinterProfilePageSizeLabel";
			this.PrinterProfilePageSizeLabel.LabelProp = global::Mono.Unix.Catalog.GetString("Page Size");
			this.PrinterProfilePageSizeLabel.Wrap = true;
			this.PrinterProfilePageSizeLabel.SingleLineMode = true;
			this.PrinterProfileScaleLayout1.Add(this.PrinterProfilePageSizeLabel);
			global::Gtk.Box.BoxChild w17 = ((global::Gtk.Box.BoxChild)(this.PrinterProfileScaleLayout1[this.PrinterProfilePageSizeLabel]));
			w17.Position = 0;
			w17.Expand = false;
			w17.Fill = false;
			// Container child PrinterProfileScaleLayout1.Gtk.Box+BoxChild
			this.PrinterProfilePageWidthEntry = new global::Gtk.Entry();
			this.PrinterProfilePageWidthEntry.TooltipMarkup = "The URL leading to the remote rules, these should be provided in JSON format matc" +
				"hing the same layout as the local rules. If no remote rules are avilable the loc" +
				"al rules will be used instead.";
			this.PrinterProfilePageWidthEntry.CanFocus = true;
			this.PrinterProfilePageWidthEntry.Name = "PrinterProfilePageWidthEntry";
			this.PrinterProfilePageWidthEntry.IsEditable = true;
			this.PrinterProfilePageWidthEntry.InvisibleChar = '•';
			this.PrinterProfileScaleLayout1.Add(this.PrinterProfilePageWidthEntry);
			global::Gtk.Box.BoxChild w18 = ((global::Gtk.Box.BoxChild)(this.PrinterProfileScaleLayout1[this.PrinterProfilePageWidthEntry]));
			w18.Position = 1;
			// Container child PrinterProfileScaleLayout1.Gtk.Box+BoxChild
			this.PrinterProfilePageHeightEntry = new global::Gtk.Entry();
			this.PrinterProfilePageHeightEntry.TooltipMarkup = "The URL leading to the remote rules, these should be provided in JSON format matc" +
				"hing the same layout as the local rules. If no remote rules are avilable the loc" +
				"al rules will be used instead.";
			this.PrinterProfilePageHeightEntry.CanFocus = true;
			this.PrinterProfilePageHeightEntry.Name = "PrinterProfilePageHeightEntry";
			this.PrinterProfilePageHeightEntry.IsEditable = true;
			this.PrinterProfilePageHeightEntry.InvisibleChar = '•';
			this.PrinterProfileScaleLayout1.Add(this.PrinterProfilePageHeightEntry);
			global::Gtk.Box.BoxChild w19 = ((global::Gtk.Box.BoxChild)(this.PrinterProfileScaleLayout1[this.PrinterProfilePageHeightEntry]));
			w19.Position = 2;
			this.PrinterProfileDetailsLayout.Add(this.PrinterProfileScaleLayout1);
			global::Gtk.Box.BoxChild w20 = ((global::Gtk.Box.BoxChild)(this.PrinterProfileDetailsLayout[this.PrinterProfileScaleLayout1]));
			w20.Position = 3;
			w20.Expand = false;
			w20.Fill = false;
			// Container child PrinterProfileDetailsLayout.Gtk.Box+BoxChild
			...
			global::Gtk.Box.BoxChild w21 = ((global::Gtk.Box.BoxChild)(this.PrinterProfileDetailsLayout[this.PrinterProfileSaveButton]));
			w21.Position = 4;
			w21.Expand = false;
			w21.Fill = false;
			...
			global::Gtk.Box.BoxChild w24 = ((global::Gtk.Box.BoxChild)(this.MainLayout[this.frame1]));
			w24.Position = 1;
			w24.Expand = false;
			w24.Fill = false;
			// Container child MainLayout.Gtk.Box+BoxChild
			...
			this.CancelButton.Image = w25;
			this.MainControlsLayout.Add(this.CancelButton);
			global::Gtk.Box.BoxChild w26 = ((global::Gtk.Box.BoxChild)(this.MainControlsLayout[this.CancelButton]));
			w26.Position = 1;
			w26.Expand = false;
			w26.Fill = false;
			// Container child MainControlsLayout.Gtk.Box+BoxChild
			...
			this.ConfirmButton.Image = w27;
			this.MainControlsLayout.Add(this.ConfirmButton);
			global::Gtk.Box.BoxChild w28 = ((global::Gtk.Box.BoxChild)(this.MainControlsLayout[this.ConfirmButton]));
			w28.Position = 2;
			w28.Expand = false;
			w28.Fill = false;
			this.MainLayout.Add(this.MainControlsLayout);
			global::Gtk.Box.BoxChild w29 = ((global::Gtk.Box.BoxChild)(this.MainLayout[this.MainControlsLayout]));
			w29.Position = 2;
			w29.Expand = false;
			w29.Fill = false;
